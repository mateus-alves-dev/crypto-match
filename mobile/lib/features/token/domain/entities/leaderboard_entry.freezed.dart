...
mixin _$LeaderboardEntry {
 ...
 int get rank; String get userId; String get displayName; double get weeklyTokens; bool get hasWeeklyBadge; bool get isCurrentUser; String? get avatarUrl;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LeaderboardEntry&&(identical(other.rank, rank) || other.rank == rank)&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.weeklyTokens, weeklyTokens) || other.weeklyTokens == weeklyTokens)&&(identical(other.hasWeeklyBadge, hasWeeklyBadge) || other.hasWeeklyBadge == hasWeeklyBadge)&&(identical(other.isCurrentUser, isCurrentUser) || other.isCurrentUser == isCurrentUser)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,rank,userId,displayName,weeklyTokens,hasWeeklyBadge,isCurrentUser,avatarUrl);
...
@useResult
$Res call({
 int rank, String userId, String displayName, double weeklyTokens, bool hasWeeklyBadge, bool isCurrentUser, String? avatarUrl
});
...
/// Create a copy of LeaderboardEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? rank = null,Object? userId = null,Object? displayName = null,Object? weeklyTokens = null,Object? hasWeeklyBadge = null,Object? isCurrentUser = null,Object? avatarUrl = freezed,}) {
  return _then(_self.copyWith(
rank: null == rank ? _self.rank : rank // ignore: cast_nullable_to_non_nullable
as int,userId: null == userId ? _self.userId : userId // ignore: cast_nullable_to_non_nullable
as String,displayName: null == displayName ? _self.displayName : displayName // ignore: cast_nullable_to_non_nullable
as String,weeklyTokens: null == weeklyTokens ? _self.weeklyTokens : weeklyTokens // ignore: cast_nullable_to_non_nullable
as double,hasWeeklyBadge: null == hasWeeklyBadge ? _self.hasWeeklyBadge : hasWeeklyBadge // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int rank,  String userId,  String displayName,  double weeklyTokens,  bool hasWeeklyBadge,  bool isCurrentUser,  String? avatarUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LeaderboardEntry() when $default != null:
return $default(_that.rank,_that.userId,_that.displayName,_that.weeklyTokens,_that.hasWeeklyBadge,_that.isCurrentUser,_that.avatarUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int rank,  String userId,  String displayName,  double weeklyTokens,  bool hasWeeklyBadge,  bool isCurrentUser,  String? avatarUrl)  $default,) {final _that = this;
switch (_that) {
case _LeaderboardEntry():
return $default(_that.rank,_that.userId,_that.displayName,_that.weeklyTokens,_that.hasWeeklyBadge,_that.isCurrentUser,_that.avatarUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int rank,  String userId,  String displayName,  double weeklyTokens,  bool hasWeeklyBadge,  bool isCurrentUser,  String? avatarUrl)?  $default,) {final _that = this;
switch (_that) {
case _LeaderboardEntry() when $default != null:
return $default(_that.rank,_that.userId,_that.displayName,_that.weeklyTokens,_that.hasWeeklyBadge,_that.isCurrentUser,_that.avatarUrl);case _:
  return null;
...
class _LeaderboardEntry implements LeaderboardEntry {
  const _LeaderboardEntry({required this.rank, required this.userId, required this.displayName, required this.weeklyTokens, required this.hasWeeklyBadge, required this.isCurrentUser, this.avatarUrl});
  factory _LeaderboardEntry.fromJson(Map<String, dynamic> json) => _$LeaderboardEntryFromJson(json);

@override final  int rank;
@override final  String userId;
@override final  String displayName;
@override final  double weeklyTokens;
@override final  bool hasWeeklyBadge;
...
/// Create a copy of LeaderboardEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? rank = null,Object? userId = null,Object? displayName = null,Object? weeklyTokens = null,Object? hasWeeklyBadge = null,Object? isCurrentUser = null,Object? avatarUrl = freezed,}) {
